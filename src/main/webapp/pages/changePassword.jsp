...
<body data-ng-controller="ChangeController" ng-cloak>
			...
			<div class="col-md-4">
                    ...
                    <form>
                        <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon input-icon-show"></i>
                            ...
                            <input class="form-control" ng-model="oldpwd"  placeholder="Enter Old Password" type="password" />
                            
                        </div>
                        <div class="form-group form-group-icon-left"><i class="fa fa-lock input-icon input-icon-show"></i>
                            <label>New Password</label>
                            <input class="form-control" ng-model="newpwd" type="password" placeholder="Your new secret password" />
                        </div>
                        
                        <div class="form-group form-group-icon-left"><i class="fa fa-lock input-icon input-icon-show"></i>
                            <label>Repeat Password</label>
                            <input class="form-control" ng-model="repeatpwd" type="password" placeholder="Repeat your new secret password" />
                        </div>
                        
                       <a ng-click="changePWD()"> <input class="btn btn-primary" style="background-color : #d84e55;" type="submit" value="Change Password" /></a>
