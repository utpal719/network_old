...
<body data-ng-controller="adminCitycontroller" class="hold-transition layout-boxed sidebar-collapse skin-black-light sidebar-mini" style="color : RGBA(40, 62, 60, 0.67);font-size : 12px;">
    <div class="wrapper">
...
<a href="adminAddCity.jsp"><button class="btn btn-block btn-primary" style="width:20%;">Add New City</button></a>
                  ...
                  <table id="example2" class="table table-bordered table-hover" >
                    ...
                    <tbody>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a ng-click="deleteCity(n.cityId)" >Delete</a></li>
