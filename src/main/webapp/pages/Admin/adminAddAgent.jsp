...
<body data-ng-controller="adminAddAgentcontroller" class="hold-transition layout-boxed sidebar-collapse skin-black-light sidebar-mini" style="color : RGBA(40, 62, 60, 0.67);font-size : 12px;">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        		...
        		<form style="width:70%; margin-left:20%;"> 
        		<h3><font style="margin-left:10%;">Add New Agent</font></h3>
        		<div class="box-body">
                    <div class="form-group">
                      <label>Agent Name</label>
                     <input class="form-control" type="text" ng-model="name" placeholder="Enter Agent Name">
                     <span ng-if="invalidName" style="color:rgba(210, 59, 59, 0.77);">*Please enter agnet Name</span>
                 </div>
                 <div class="form-group">
                      <label>User Name</label>
                     <input class="form-control" type="text" ng-model="username" placeholder="Enter Agent User Name">
                     <span ng-if="invalidUserName" style="color:rgba(210, 59, 59, 0.77);">*Please enter user Name</span>
                 </div>
                 <div class="form-group">
                      <label>Password</label>
                     <input class="form-control" type="password" ng-model="pwd" placeholder="Enter Agent Password">
                     <span ng-if="invalidPassword" style="color:rgba(210, 59, 59, 0.77);">*Please enter password</span>
                 </div>
                 <div class="form-group">
                      <label>Percentage %</label>
                     <input class="form-control" type="text" ng-model="percentage" placeholder="Enter Agent percentage">
                     <span ng-if="invalidpercentage" style="color:rgba(210, 59, 59, 0.77);">*Please enter agnet percentage</span>
                 </div>
                 
                 <div class="form-group">
                      <label>Address</label>
                     <input class="form-control" type="text" ng-model="address" placeholder="Enter Address">
                     <span ng-if="invalidAddress" style="color:rgba(210, 59, 59, 0.77);">*Please enter Address</span>
                 </div>
                 <div class="form-group">
                      <label>Email</label>
                     <input class="form-control" type="text" ng-model="email" placeholder="Enter Email">
                     <span ng-if="invalidemail" style="color:rgba(210, 59, 59, 0.77);">*Please enter EmailId</span>
                 </div>
                 
                 <div class="form-group">
                      <label>Mobile</label>
                     <input class="form-control" type="text" ng-model="mobile" placeholder="Enter Mobile">
                     <span ng-if="invalidMobile" style="color:rgba(210, 59, 59, 0.77);">*Please enter Mobile</span>
                 </div>
                 
                 <a ng-click="addAgent()"><button class="btn btn-block btn-primary" style="width:20%;">Add Agent</button></a> 
