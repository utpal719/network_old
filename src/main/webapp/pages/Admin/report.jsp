...
<body data-ng-controller="reportcontroller" id="body" class="hold-transition layout-boxed sidebar-collapse skin-black-light sidebar-mini" style="color : RGBA(40, 62, 60, 0.67);font-size : 12px;">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<br>
        		<a ng-click="viewReport()" style="margin-top:1%;"><button class="btn btn-block btn-primary" style="width:13%;">View Report</button></a>
        			
        	</form>
        
      
        <div ng-if="reportView" style="margin-top:10%; width : 70%;margin-left:20%;" id="printableArea">
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover" >
                      ...
                      <tr>
                    	...
                    	<tr ng-repeat="n in adminreport">
                    		<td>{{n.booking.pnrNumber}}</td>
                    		<td>{{n.booking.fromCity}}</td>
                    		<td>{{n.booking.toCity}}</td>
                    		<td>{{n.booking.boardingPoint}}</td>
                    		<td>{{n.booking.mobile}}</td>
                    		<td>{{n.booking.paymentStatus}}</td>
                    		<td>{{n.bookedUser}}</td>
                    	</tr>
