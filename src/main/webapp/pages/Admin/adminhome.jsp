...
<body data-ng-controller="admincontroller" id="body" class="hold-transition layout-boxed sidebar-collapse skin-black-light sidebar-mini" style="color : RGBA(40, 62, 60, 0.67);font-size : 12px;">
    <div class="wrapper">
...
<!--              <li class="active">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        		...
        		<div class="col-md-4" >
        		 ...
        		 <div class="form-group">
                     <label>Select Bus</label>
                      	 <select class="form-control" ng-model="busid" ng-options = "n.busId as n.label for n in adminbuses | orderBy : label">
                     	</select>
        	...
        	<br>
        		<a ng-click="viewTickets()" style="margin-top:1%;"><button class="btn btn-block btn-primary" style="width:13%;">View Tickets</button></a>
        ...
        <div class="row">
           <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body" style="padding-top: 1px !important;">
                  <table id="example2" class="table table-bordered table-hover" >
                  	<thead>
                      <tr>
                      	<th style="width: 5%">SeatNo</th>
                        <th>Passenger Name</th>
                        <th style="width : 25%;">Boarding Point</th>
                        <th>Mobile</th>
                        <th>PNR Number</th>
                     	<th>Destination</th>
                       	<th>Agent</th>
