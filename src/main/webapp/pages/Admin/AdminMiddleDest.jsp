...
<body data-ng-controller="adminMiddleController" class="hold-transition layout-boxed sidebar-collapse skin-black-light sidebar-mini" style="color : RGBA(40, 62, 60, 0.67);font-size : 12px;">
    <div class="wrapper">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover" >
          		 ...
          		 <li><a ng-click="deleteMidDest(n.midId)" >Delete</a></li>
