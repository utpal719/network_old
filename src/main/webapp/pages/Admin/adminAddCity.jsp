...
<body data-ng-controller="adminAddCitycontroller" class="hold-transition layout-boxed sidebar-collapse skin-black-light sidebar-mini" style="color : RGBA(40, 62, 60, 0.67);font-size : 12px;">
    <div class="wrapper">
        		...
        		<div class="box-body">
                    <div class="form-group">
                      <label>City Name</label>
                       ...
                       <span ng-if="invalidcityName" style="color:rgba(210, 59, 59, 0.77);">*City Name can't be blank</span>
                 
                   </div>
                   
                    <a ng-click="addNewCity()"><button class="btn btn-block btn-primary" style="width:20%;">Add New City</button></a>
