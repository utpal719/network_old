...
<body data-ng-controller="adminaddBuscontroller" class="hold-transition layout-boxed sidebar-collapse skin-black-light sidebar-mini" style="color : RGBA(40, 62, 60, 0.67);font-size : 12px;">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
        		...
        		<h3><font style="margin-left:10%;">Add Bus</font></h3>
        		<div class="box-body">
                    <div class="form-group">
                      <label>From City</label>
                      
                      <select class="form-control" ng-model="fromcity" ng-options = "n.cityId as n.cityName for n in cityList">
                      	
                      </select>
                      <span ng-if="invalidfromcity" style="color:rgba(210, 59, 59, 0.77);">*Please select a city</span>
                      
                    </div>
                    <div class="form-group">
                      <label>To City</label>
                       <select class="form-control" ng-model="tocity" ng-options = "n.cityId as n.cityName for n in cityList"></select>
                       
                       <span ng-if="invalidtocity" style="color:rgba(210, 59, 59, 0.77);">*Please select a city</span> 
                    </div>
                    <div class="form-group">
                      <label>Start Time (HH:mm) in 24 hr format</label>
                      <input type="text" class="form-control" ng-model="starttime" placeholder="e.g. : 15:30">
                       <span ng-if="invalidstarttime" style="color:rgba(210, 59, 59, 0.77);">*Please enter start time</span>
                    </div>
                    <div class="form-group">
                      <label>End Time (HH:mm) in 24 hr format</label>
                      <input type="text" class="form-control" ng-model="endtime"  placeholder="e.g. : 15:30">
                       <span ng-if="invalidendtime" style="color:rgba(210, 59, 59, 0.77);">*Please enter end time</span>
                    </div>
                    <div class="form-group">
                      <label>Seat Capacity</label>
                      <input type="text" class="form-control" ng-model="seatCapacity" placeholder="Enter Seat Capacity">
                       <span ng-if="invalidseat" style="color:rgba(210, 59, 59, 0.77);">*Please enter seat capacity</span>
                    </div>
                    <div class="form-group">
                      <label>Fare</label>
                      <input type="text" class="form-control" ng-model="fare" placeholder="Enter fare">
                       <span ng-if="invalidfare" style="color:rgba(210, 59, 59, 0.77);">*Please enter fare</span>
                    </div>
                    
                   <a ng-click="addBus()"><button class="btn btn-block btn-primary" style="width:20%;">Add Bus</button></a> 
