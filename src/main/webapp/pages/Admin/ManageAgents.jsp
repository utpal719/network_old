...
<body data-ng-controller="adminAgentcontroller" class="hold-transition layout-boxed sidebar-collapse skin-black-light sidebar-mini" style="color : RGBA(40, 62, 60, 0.67);font-size : 12px;">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class="col-md-12" style="margin:1%;">
			<a href="adminAddAgent.jsp"><button class="btn btn-block btn-primary" style="width:20%;">Add New Agent</button></a>
		</div>	
                  ...
                  <table id="example2" class="table table-bordered table-hover" >
                    ...
                    <tbody>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a ng-click="deleteAgent(n.userid)" >Delete</a></li>
