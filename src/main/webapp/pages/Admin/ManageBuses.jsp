...
<body data-ng-controller="adminBusController" class="hold-transition layout-boxed sidebar-collapse skin-black-light sidebar-mini" style="color : RGBA(40, 62, 60, 0.67);font-size : 12px;" >
    <div class="wrapper">
...
<a href="adminAddBus.jsp"><button class="btn btn-block btn-primary" style="width:20%;">Add Bus</button></a>
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover" >
                    ...
                    <tbody>
                    	<tr ng-repeat="n in adminbuses">
                        <td>{{n.busId}}</td>
                        <td>{{n.fromCity}}</td>
                        <td>{{n.toCity}}</td>
                        <td>{{n.startTime}}</td>
                        <td>{{n.seatCapacity}}</td>
                        <td>{{n.fare}}</td>
                        <td>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a ng-click="viewMiddleDest(n.busId)">View Middle Destinations</a></li>
                        <li><a ng-click="deleteBus(n.busId)" >Delete</a></li>
